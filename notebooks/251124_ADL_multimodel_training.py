...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs, filename, patience=50):
...
if hyperparameter_tuning:
    ...
    for lr, batch_size, epochs in itertools.product(
        ...
        # ----- Train -----
        logs = train_model(model, train_loader, val_loader, loss_fn, optimizer, epochs,filename=run_name, patience=3)
