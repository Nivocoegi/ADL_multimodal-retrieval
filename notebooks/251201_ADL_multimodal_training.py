    ...
    def compute_metrics(model, processor, dataloader):
        ...
        with torch.no_grad():
            for images, texts in dataloader:
                inputs = processor(text=texts, images=images, padding=True, trunction=True, max_length=77,  return_tensors="pt").to(DEVICE)
...
if not hyperparameter_tuning:
   logs = train_model(model, train_loader, val_loader, loss_fn, optimizer, epochs, filename, current_stage, unfreeze_every, unfreeze_stages, patience=1)
